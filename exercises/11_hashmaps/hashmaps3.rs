...
fn build_scores_table(results: &str) -> HashMap<&str, TeamScores> {
    ...
    for line in results.lines() {
        ...
        let team_1_score: u8 = split_iterator.next().unwrap().parse().unwrap(); // goals conceded by team 2
        let team_2_score: u8 = split_iterator.next().unwrap().parse().unwrap(); // goals conceded by team 1
